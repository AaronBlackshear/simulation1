...
export default class Form extends Component{
    constructor(props){
        ...
        this.state={
            imageUrl: '',
            placeholder: 'http://www.pixedelic.com/themes/geode/demo/wp-content/uploads/sites/4/2014/04/placeholder2.png',
            productName: '',
            price: '',
            currentId: null,
            currentProp: ''
    ...
    editProduct(img,name,price,id){
        axios.put(`/api/products/${id}`, {img,name,price})
    ...
    addProduct(imgurl,productname,price){
        ...
        axios.post('/api/products', {imgurl,productname,price})
        .then(res => {this.props.component(), this.clearForm()})
    ...
    render(){
        ...
        return (
            ...
            <div className='container'>
                ...
                <h4>Image URL:</h4>
                <input value={imageUrl} onChange={e => this.addImageUrl(e.target.value)} />
                <h4>Product Name:</h4>
                <input value={productName} onChange={e => this.addProductName(e.target.value)} />
                <h4>Price:</h4>
